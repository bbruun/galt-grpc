...
const (
	...
	MinionService_CmdRun_FullMethodName            = "/minion.MinionService/CmdRun"
)
...
type MinionService_GetCommandsClient interface {
	Recv() (*SendCommandResultToMinion, error)
	grpc.ClientStream
}
...
func (x *minionServiceGetCommandsClient) Recv() (*SendCommandResultToMinion, error) {
	m := new(SendCommandResultToMinion)
...
func (c *minionServiceClient) CmdRun(ctx context.Context, in *CmdRunFromClient, opts ...grpc.CallOption) (MinionService_CmdRunClient, error) {
	stream, err := c.cc.NewStream(ctx, &MinionService_ServiceDesc.Streams[1], MinionService_CmdRun_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type MinionService_GetCommandsServer interface {
	Send(*SendCommandResultToMinion) error
	grpc.ServerStream
}
...
func (x *minionServiceGetCommandsServer) Send(m *SendCommandResultToMinion) error {
